...
const (
	...
	APIUpdateProposalBody              = "Update proposal body for proposal #%s ... "
...
Please upgrade to the new format: create.new-branch-type = "prototype"`
	...
	ForgeGitlabUpdateMRBodyViaAPI       = "Updating merge-request body for MR #%d ... "
	...
	ForgeGiteaUpdatePRBodyViaAPI        = "Gitea API: Updating pull-request description for PR #%d"
	ForgeGitHubMergingViaAPI            = "GitHub API: merging PR %s ... "
	ForgeGithubUpdatePRBodyViaAPI       = "Github API: Updating pull-request description for PR #%d ... "
